    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="model/img/profile_small.jpg" /></span>
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold">Beaut-zihan</strong></span>
                                <span class="text-muted text-xs block">${activeUser.username}</span>
                                </span>
                            </a>
                        </div>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                           <c:forEach items="${activeUser.permissions }" var="permisssion">
								<li>
									<a class="J_menuItem" href="${permisssion.url }" target="text">${permisssion.name }</a>
								</li>
							</c:forEach>
                        </ul>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row content-tabs">
                ...
                <a href="loginview" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
            </div>
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="http://localhost:8080/SSM/welcome" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
            <div class="footer">
